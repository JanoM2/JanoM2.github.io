...
import { ContactForm } from "../Helpers/form.js";
...
export default function Contacto() {
  ...
  $article.classList.add("contacto--article");
  $contacto.classList.add("contacto");

  $contacto.appendChild(Hr());
  $contacto.appendChild(Title("contacto", "Contacto"));
  ...
  setTimeout(() => {
    document
      .querySelector(".contacto--container")
      .appendChild(Icons("contacto"));
  }, 1);

  $contacto.appendChild($article);
